<span data-ttu-id="bf3b6-101">In questa unità verrà creata un'app Web ASP.NET Core.</span><span class="sxs-lookup"><span data-stu-id="bf3b6-101">In this unit, you will create an ASP.NET Core web app.</span></span>
