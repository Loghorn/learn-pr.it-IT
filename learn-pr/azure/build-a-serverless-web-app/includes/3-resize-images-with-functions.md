...
In questa unità è stata creata una funzione serverless per creare un'anteprima ogni volta che viene caricata un'immagine in un contenitore di archiviazione BLOB. Si vedrà ora come usare Azure Cosmos DB per archiviare ed elencare i metadati delle immagini.