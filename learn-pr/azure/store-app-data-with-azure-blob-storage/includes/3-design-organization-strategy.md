Quando si progetta un'app che richiede l'archiviazione di dati, è importante pensare al modo in cui l'app organizzerà e archivierà i dati tra gli account di archiviazione, i contenitori e i BLOB.
