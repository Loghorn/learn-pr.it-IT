...
1. Assicurarsi di aver eseguito l'accesso al [portale di Azure](https://portal.azure.com/learn.docs.microsoft.com?azure-portal=true) usando lo stesso account con cui è stato attivata la sandbox.
...
1. Per aprire la scheda dell'integrazione, selezionare **Integra** nel riquadro a sinistra. Il modello usato ha creato automaticamente un trigger HTTP e un'associazione di output HTTP. È ora possibile aggiungere la nuova associazione di input di Azure Cosmos DB.
