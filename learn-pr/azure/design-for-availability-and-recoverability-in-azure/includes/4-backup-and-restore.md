...
Per stabilire i requisiti di backup per l'app, prendere nota dei dati dell'applicazione ed eseguire un'analisi per raggrupparli in base ai requisiti seguenti:
