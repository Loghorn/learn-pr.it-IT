Dopo che aver valutato i database e corretto gli errori segnalati, si è pronti per la migrazione del database. In questo esercizio, si eseguirà la migrazione di un database SQL a SQL di Azure.
