L'app e la funzione di Azure sono ora complete e in esecuzione in locale. In questa unità verrà pubblicata la funzione di Azure in Azure per l'esecuzione nel cloud.
