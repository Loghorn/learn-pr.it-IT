## <a name="get-an-access-key"></a><span data-ttu-id="bed30-101">Ottenere una chiave di accesso</span><span class="sxs-lookup"><span data-stu-id="bed30-101">Get an access key</span></span>
