...
1. Fare clic su **Crea** per creare e distribuire la macchina virtuale. Il dashboard di Azure mostrerà la macchina virtuale in fase di distribuzione. Questa operazione può richiedere alcuni minuti.
