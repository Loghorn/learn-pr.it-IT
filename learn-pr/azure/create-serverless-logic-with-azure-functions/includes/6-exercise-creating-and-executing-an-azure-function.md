...
1. Verranno visualizzate le risorse del gruppo. Accedere all'app per le funzioni creata nell'esercizio precedente selezionando l'elemento **escalator-functions-xxxxxxx**, contrassegnato anche con l'icona a forma di fulmine.
...
![Screenshot delle schede "Test" e "Log" nell'interfaccia delle funzioni all'interno del portale. Nel riquadro di output della scheda "Test" è visualizzata un esempio di risposta inviata dalla funzione.](../images/6-portal-testing.png)
