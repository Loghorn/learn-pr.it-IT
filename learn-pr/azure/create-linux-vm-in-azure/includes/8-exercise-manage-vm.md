...
1. Nella pagina Panoramica si noterà che sono presenti alcune regole predefinite create per bloccare la rete.
    ...
    - Tutto il restante traffico in ingresso viene rifiutato.
    Sul lato in uscita:
...
> [!NOTE]
> Queste regole predefinite vengono impostate con valori di priorità elevata pertanto, vengono valutate per _ultime_. Non possono essere modificate o eliminate, ma è possibile eseguirne l'_override_ creando regole più specifiche per il traffico con un valore di priorità più basso.
