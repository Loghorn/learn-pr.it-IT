...
Qualsiasi applicazione supportata dal computer può essere inclusa nell'immagine della macchina virtuale. È possibile creare una macchina virtuale da un'immagine preconfigurata esattamente per i propri requisiti, ad esempio l'hosting di un'app ASP.Net Core.
